...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_NAME1 + " (ID_MIEJSCA INTEGER PRIMARY KEY AUTOINCREMENT, NAZWA TEXT, SZEROKOŚĆ FLOAT, DŁUGOŚĆ FLOAT, KATEGORIA TEXT)");
        db.execSQL("create table " + TABLE_NAME2 + " (ID_PROMOCJI INTEGER PRIMARY KEY AUTOINCREMENT, ID_MIEJSCA INTEGER, OBNIŻKA INTEGER, UWAGI TEXT)");
